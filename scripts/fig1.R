...
par(mfrow = c(2,4), oma = c(8,1,5,1), mar = c(0, 5, 2, 1), 
...
box(lwd = 0.5)
mtext(side = 3, text = "A", adj = 0.02, line = 0, font = 2)
...
box(lwd = 0.5)
mtext(side = 3, text = "B", adj = 0.02, line = 0, font = 2)
...
box(lwd = 0.5)
mtext(side = 3, text = "F", adj = 0.02, line = 0, font = 2)
...
box(lwd = 0.5)
mtext(side = 3, text = "G", adj = 0.02, line = 0, font = 2)

# Legend
plot(sp_by_location$log_seed_area~jitter(sp_by_location$elevation, factor = .3), 
     xlab = "", bty = "n", bg = colvec, type="n", ylab = "", xaxt="n", yaxt="n")
legend(x=0, y=6.5, pch = pchs, 
       pt.bg = c("black", "grey", "white"), xpd = NA, y.intersp = 1,
